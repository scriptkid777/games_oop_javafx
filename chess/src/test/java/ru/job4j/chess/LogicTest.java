...
public class LogicTest {
    ...
    @Test
    public void moveValid() throws FigureNotFoundException, OccupiedCellException, ImpossibleMoveException {
    ...
    public void moveFigureNotFound() throws FigureNotFoundException, OccupiedCellException, ImpossibleMoveException {
        Logic logic = new Logic();
        logic.add(new BishopBlack(Cell.C1));
